...
public class PhoneStateService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void onCreate() {
        ...
        preferences.registerOnSharedPreferenceChangeListener(new SharedPreferences.OnSharedPreferenceChangeListener() {
            ...
            public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
                if ("allow_no_location".equals(key)) {
                    setAllowNoLocation(sharedPreferences.getBoolean("allow_no_location", false));
                }
            }
        });
    ...
    protected void setAllowNoLocation(boolean allowNoLocation) {
        if (allowNoLocation) {
            DATA_REQUIRED.remove(DATA_LOCATION);
        } else {
            DATA_REQUIRED.add(DATA_LOCATION);
        }
    }
